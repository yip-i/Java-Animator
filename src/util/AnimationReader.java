...
public class AnimationReader {
   ...
   * @param <AnimatedMovieModelInterface>    The main model interface type describing animations.
   * @return
   */
  public static <AnimatedMovieModelInterface> AnimatedMovieModelInterface parseFile(
      Readable readable, AnimationBuilder<AnimatedMovieModelInterface> builder) {
  ...
  private static <AnimatedMovieModelInterface> void readCanvas(Scanner s,
      AnimationBuilder<AnimatedMovieModelInterface> builder) {
    int[] vals = new int[4];
  ...
  private static <AnimatedMovieModelInterface> void readShape(Scanner s,
      AnimationBuilder<AnimatedMovieModelInterface> builder) {
    String name;
    String type;
    if (s.hasNext()) {
  ...
  private static <AnimatedMovieModelInterface> void readMotion(Scanner s,
      AnimationBuilder<AnimatedMovieModelInterface> builder) {
